...
//("animeId:", animeId);  // Log the animeId value
//("dataId:", dataId);    // Log the dataId value
...
}, [sortedKeys, selectedRangeKey, setSelectedRangeKey]);
...
>
  ...
  return (
    <div>
      {allState && <div className='all'></div>}
      {isSignIn && <div className='register'>
        ...
        <div><img alt="image3" style={{position:'relative',right:'20px',width:'250px'}} src='https://9animetv.to/images/icon-login2.png'/></div>
      ...
      {isSignUp && <div className='register'>
        ...
        <div><img alt="image4" style={{position:'relative',right:'20px',width:'250px'}} src='https://9animetv.to/images/icon-register.png'/></div>
        <div style={{height:'auto',display:'flex',flexDirection:'column',justifyContent:'space-between'}}>
                      ...
                      <div ref={ress} id='ress'>
                        {results && results.map((elm,index)=>(
                          <Link to={`/watch?dataId=${elm.dataId}&animeId=${elm.animeId}`}><div key={index} style={{margin:'10px 0',display:'flex',alignItems:'center'}}>
                            <div><img alt="image5" style={{objectFit:'cover',width:'50px',height:'50px',borderRadius:'50%'}} src={elm.poster}/></div>
...
<div>
<img alt="image1" id='kol' src={animeData && animeData.poster}/>
</div>
  ...
  <p>Producers : <span style={{color:'#eee'}}>{animeData?.producers?.join(', ') || 'N/A'}</span></p>
    ...
    <div>
      ...
      <div style={{position:'relative',padding:'10px',backgroundColor:'#222',width:'100%',height:'fit-content',paddingBottom:'30px'}}>
        <img alt="image2" id='maga' src='https://9animetv.to/images/footer-icon.png'/>
